...
def test_create_course(courses_list_page: CoursesListPage, create_course_page: CreateCoursePage,
                       create_course_form_component:CreateCourseFormComponent,
                       create_course_exercises: CreateCourseExercisesToolbarViewComponent) -> Page:
    ...
    create_course_exercises.check_visible()
    create_course_exercises.click_create_exercise_button()
    create_course_page.check_visible_exercises_empty_view()

    create_course_page.image_upload_widget.upload_preview_image('./testdata/files/image.png')
    create_course_page.image_upload_widget.check_visible(is_image_uploaded=True)

    create_course_form_component.fill(title="Playwright", estimated_time="2 weeks", description="Playwright",
